...
Teaspoon.configure do |config|
  ...
  config.suite do |suite|
    ...
    suite.no_coverage = [%r{/lib/ruby/gems/}, %r{/vendor/assets/}, %r{/support/}, %r{/(.+)_helper.},
                         %r{.*bootstrap-sass-3.2.0.2/}, %r{/spec/javascripts/vendors/}, %r{/spec/javascripts/lib/}, %r{.*jquery-ui/}]
  ...
  config.suite :models_suite do |suite|
    suite.use_framework :jasmine, "1.3.1"
    suite.no_coverage = [%r{/lib/ruby/gems/}, %r{/vendor/assets/}, %r{/support/}, %r{/(.+)_helper.},
                         %r{.*bootstrap-sass-3.2.0.2/}, %r{/spec/javascripts/vendors/}, %r{/spec/javascripts/lib/}, %r{.*jquery-ui/}]
    suite.matcher = "{spec/javascripts/models,app/assets}/**/*_spec.{js,js.coffee,coffee}"
  end

  config.suite :collections_suite do |suite|
    suite.use_framework :jasmine, "1.3.1"
    suite.no_coverage = [%r{/lib/ruby/gems/}, %r{/vendor/assets/}, %r{/support/}, %r{/(.+)_helper.},
                         %r{.*bootstrap-sass-3.2.0.2/}, %r{/spec/javascripts/vendors/}, %r{/spec/javascripts/lib/}, %r{.*jquery-ui/}]
    suite.matcher = "{spec/javascripts/collections,app/assets}/**/*_spec.{js,js.coffee,coffee}"
  end

  config.suite :routers_suite do |suite|
    suite.use_framework :jasmine, "1.3.1"
    suite.no_coverage = [%r{/lib/ruby/gems/}, %r{/vendor/assets/}, %r{/support/}, %r{/(.+)_helper.},
                         %r{.*bootstrap-sass-3.2.0.2/}, %r{/spec/javascripts/vendors/}, %r{/spec/javascripts/lib/}, %r{.*jquery-ui/}]
    suite.matcher = "{spec/javascripts/routers,app/assets}/**/*_spec.{js,js.coffee,coffee}"
  end

  config.suite :views_suite do |suite|
    suite.use_framework :jasmine, "1.3.1"
    suite.no_coverage = [%r{/lib/ruby/gems/}, %r{/vendor/assets/}, %r{/support/}, %r{/(.+)_helper.},
                         %r{.*bootstrap-sass-3.2.0.2/}, %r{/spec/javascripts/vendors/}, %r{/spec/javascripts/lib/}, %r{.*jquery-ui/}]
    suite.matcher = "{spec/javascripts/views,app/assets}/**/*_spec.{js,js.coffee,coffee}"
  end

  config.suite :turing_email_app_suite_1 do |suite|
    suite.use_framework :jasmine, "1.3.1"
    suite.no_coverage = [%r{/lib/ruby/gems/}, %r{/vendor/assets/}, %r{/support/}, %r{/(.+)_helper.},
                         %r{.*bootstrap-sass-3.2.0.2/}, %r{/spec/javascripts/vendors/}, %r{/spec/javascripts/lib/}, %r{.*jquery-ui/}]
    suite.matcher = "{spec/javascripts/turing_email_app_suite_1,app/assets}/**/*_spec.{js,js.coffee,coffee}"
  end

  config.suite :turing_email_app_suite_2 do |suite|
    suite.use_framework :jasmine, "1.3.1"
    suite.no_coverage = [%r{/lib/ruby/gems/}, %r{/vendor/assets/}, %r{/support/}, %r{/(.+)_helper.},
                         %r{.*bootstrap-sass-3.2.0.2/}, %r{/spec/javascripts/vendors/}, %r{/spec/javascripts/lib/}, %r{.*jquery-ui/}]
    suite.matcher = "{spec/javascripts/turing_email_app_suite_2,app/assets}/**/*_spec.{js,js.coffee,coffee}"
  end
  ...
  config.driver_timeout = 60 * 60 * 10
